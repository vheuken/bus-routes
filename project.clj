(defproject bus-routes "0.1.0-SNAPSHOT"
                  ...
                  {:builds
                   {:app
                    {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
                     :figwheel {:on-jsload "bus-routes.core/mount-components"}
                     :compiler
                     {:main "bus-routes.app"
                      :asset-path "/js/out"
                      :output-to "target/cljsbuild/public/js/app.js"
